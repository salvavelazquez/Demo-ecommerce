...
//             <button className="w-full bg-indigo-600 text-gray-700 py-3 rounded-xl border-2 border-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition duration-200">
//               Ver mis órdenes
//             </button>
//           </Link>
//         </div>
